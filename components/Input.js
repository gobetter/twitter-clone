...
//   // let length = document.querySelectorAll('em-emoji-picker').length;
...
//   //   length = document.querySelectorAll('em-emoji-picker').length;
//   // }
        ...
        <div className={`${selectedFile && 'pb-7'} ${input && 'space-y-2.5'}`}>
          ...
          {selectedFile && (
            <div className='relative'>
              <div
                className='absolute w-8 h-8 bg-[#15181c] hover:bg-[#272c6] bg-opacity-75 rounded-full flex items-center justify-center top-1 left-1 cursor-pointer'
